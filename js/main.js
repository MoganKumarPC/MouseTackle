    ...
    /*************Author Name - Mogan Kumar P C************************/
    /*************Author Department - Cognizant Interactive @ June 2013***********/
    /*************Author ID - 358346 @ June 2013*********************************/
    /****************Author Organisation - Cognizant @ June 2013****************/
    /*************Developed using************************/
    /******************HTML4****************************/
    /******************CSS2****************************/
    /****************Javascript***********************/
        ...
        for (var i = 0; i < noOfRows; i++) {
            ...
            for (var j = 0; j < noOfCells; j++) {
                ...
                if (k == virtualStartLine) {
                    cellTextNode = document.createTextNode("Click Here to Begin");
    ...
    for (var i = 0; i < buttonTags.length; i++) {
        buttonTags[i].addEventListener('click', function (e) {
            if (e.target.innerHTML == "BEGINNER MODE") {
                mode = "BEGINNER MODE";
                window.open("game.html", "_blank", "location=0, resizable=0, toolbar=no, scrollbars=0, menubar=no, status=no, directories=no, width=900px, height=600px, left=50px, top=50px");
